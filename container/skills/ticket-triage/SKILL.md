...
# Notify dev channel (this posts the issue to #dev-gtm-rd automatically)
...
- **Source code:** `/workspace/extra/gtm-rd/` (backend in `backend/src/`, frontend in `frontend/src/`)
- **Production DB (read-only):** `psql "postgresql://readonly_user:419d19b19a8a29995e1da67c5e1b6b58@tramway.proxy.rlwy.net:48872/railway"`
- **GitHub:** `gh` CLI for issues and PRs on `gtm-innovation/gtm-rd`
