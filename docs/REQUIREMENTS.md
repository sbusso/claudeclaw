...
ClaudeClaw gives you the core functionality without that mess.
...
- Custom `claudeclaw` MCP server (inside container) provides scheduling tools
...
**ClaudeClaw** - A reference to Clawdbot (now OpenClaw).
