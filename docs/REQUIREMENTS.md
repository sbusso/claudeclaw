...
MotherClaw gives you the core functionality without that mess.
...
- Custom `motherclaw` MCP server (inside container) provides scheduling tools
...
**MotherClaw** - A reference to Clawdbot (now OpenClaw).
